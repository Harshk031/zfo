...
const FizzroomPost = () => {
    ...
    useSEO({
        title: post ? post.title + ' | ZfO Fizzroom' : 'Article Not Found | ZfO Fizzroom',
        description: post ? post.excerpt : 'The article you are looking for does not exist.',
        keywords: post ? (post.keywords || [post.category, 'craft soda', 'ZfO']) : ['ZfO', 'craft soda'],
        ogType: 'article',
        article: post ? {
        ...
        canonicalUrl: post ? 'https://www.zfo.co.in/fizzroom/' + id : 'https://www.zfo.co.in/fizzroom'
    });
        ...
        return (
            <div className='min-h-screen bg-black text-white pt-32 pb-20'>
                <div className='max-w-4xl mx-auto px-6 text-center'>
                    ...
                    <p className='text-white/70'>The article you are looking for does not exist.</p>
                </div>
            </div>
        );
    }
