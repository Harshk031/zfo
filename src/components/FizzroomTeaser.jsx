        ...
        <section className="py-24 bg-black text-white relative z-20 border-t border-white/10">
            ...
            <div className="max-w-7xl mx-auto px-6">
                ...
                <div className="mt-12 md:hidden">
                    <Link to="/fizzroom" className="flex items-center justify-center space-x-2 text-white hover:text-gray-300 transition-colors uppercase text-sm tracking-widest border border-white/20 py-4 rounded-full w-full">
                        <span>DIVE IN ↗</span>
                        <FaArrowRight />
                    </Link>
                </div>
