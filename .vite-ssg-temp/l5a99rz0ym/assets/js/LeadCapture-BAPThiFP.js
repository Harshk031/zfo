...
import { X, Clock, Sparkles, Mail, Download, Gift } from "lucide-react";
const LeadCapture = () => {
  ...
  const leadMagnets = {
    exit: {
      ...
      icon: /* @__PURE__ */ jsx(Gift, { className: "w-12 h-12 text-[#ffcc00]" }),
    ...
    scroll: {
      ...
      icon: /* @__PURE__ */ jsx(Download, { className: "w-12 h-12 text-[#ffcc00]" }),
    ...
    time: {
      ...
      icon: /* @__PURE__ */ jsx(Sparkles, { className: "w-12 h-12 text-[#ffcc00]" }),
    ...
    content: {
      ...
      icon: /* @__PURE__ */ jsx(Mail, { className: "w-12 h-12 text-[#ffcc00]" }),
      ...
      children: /* @__PURE__ */ jsxs(
        motion.div,
        {
          ...
          children: [
            ...
            /* @__PURE__ */ jsx("div", { className: "absolute top-0 left-0 w-full h-2 bg-gradient-to-r from-[#ffcc00] via-[#ff6b35] to-[#ffcc00]" }),
            /* @__PURE__ */ jsx("div", { className: "absolute -top-20 -right-20 w-40 h-40 bg-[#ffcc00]/10 rounded-full blur-3xl" }),
            /* @__PURE__ */ jsx("div", { className: "absolute -bottom-20 -left-20 w-40 h-40 bg-[#ff6b35]/10 rounded-full blur-3xl" }),
            /* @__PURE__ */ jsx("div", { className: "p-8", children: !isSubmitted ? /* @__PURE__ */ jsxs(Fragment, { children: [
              /* @__PURE__ */ jsx("div", { className: "flex justify-center mb-6", children: /* @__PURE__ */ jsx("div", { className: "p-4 bg-white/5 rounded-2xl", children: currentMagnet.icon }) }),
              /* @__PURE__ */ jsxs("div", { className: "text-center mb-6", children: [
                /* @__PURE__ */ jsx("p", { className: "text-[#ffcc00] text-sm font-medium mb-2 uppercase tracking-wider", children: currentMagnet.subtitle }),
                /* @__PURE__ */ jsx("h3", { className: "text-2xl font-bold text-white mb-3", children: currentMagnet.title }),
                /* @__PURE__ */ jsx("p", { className: "text-white/60 text-sm leading-relaxed", children: currentMagnet.description })
              ] }),
              /* @__PURE__ */ jsxs("form", { onSubmit: handleSubmit, className: "space-y-4", children: [
                ...
                /* @__PURE__ */ jsx(
                  "button",
                  {
                    ...
                    children: currentMagnet.cta
                  }
                )
              ] }),
              /* @__PURE__ */ jsx("div", { className: "mt-4 text-center", children: /* @__PURE__ */ jsxs("p", { className: "text-white/40 text-xs flex items-center justify-center gap-2", children: [
              ...
              /* @__PURE__ */ jsx(
                motion.div,
                {
                  ...
                  children: /* @__PURE__ */ jsx(Sparkles, { className: "w-10 h-10 text-green-400" })
                }
              ),
              /* @__PURE__ */ jsx("h3", { className: "text-2xl font-bold text-white mb-3", children: currentMagnet.successTitle }),
              /* @__PURE__ */ jsx("p", { className: "text-white/60", children: currentMagnet.successMessage }),
              /* @__PURE__ */ jsx(
                "button",
                {
                  onClick: closeModal,
